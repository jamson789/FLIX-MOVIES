        ...
        <div id="adminSection" class="admin-section">
            ...
            <form id="movieForm">
                ...
                <div class="form-group">
                    ...
                    <input type="url" id="coverUrl" required placeholder="https://example.com/cover.jpg">
                    <div class="movie-preview">
                        <small data-en="Cover Preview:" data-sw="Hakiki ya Cover:">Cover Preview:</small>
                        <br>
                ...
                movieCard.innerHTML = `
                    <div class="movie-thumbnail" style="background-image: url('${movie.coverUrl}')">
                        <div class="movie-play-overlay">
                            <button class="movie-play-btn" title="${translations[currentLanguage].playMovie}">▶</button>
                        </div>
                    </div>
            ...
            movies.forEach((movie, index) => {
                ...
                movieItem.innerHTML = `
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <img src="${movie.coverUrl}" style="width: 60px; height: 80px; object-fit: cover; border-radius: 5px;" alt="${movie.title}">
                        <div>
